...
import { escHtml as esc, buildCompanyHeader, buildPaymentDetails } from "@/lib/utils/printUtils";
...
<body>
  ...
  <div class="terms">
    ...
    <ol>
      <li>This quotation is valid for 30 days from the date of issue unless stated otherwise.</li>
      <li>Prices are inclusive of applicable GST as mentioned above.</li>
      <li>Delivery charges, if any, will be communicated separately.</li>
      <li>Payment terms: 50% advance, 50% on delivery unless agreed otherwise.</li>
      <li>Warranty as per manufacturer's standard policy.</li>
      <li>Goods once sold will not be taken back unless found defective.</li>
    </ol>
  </div>

  <div class="footer">
    <div style="font-size:10px;color:#94a3b8">
      Generated by CompanyOS &nbsp;·&nbsp; ${new Date().toLocaleDateString("en-IN")}
    </div>
    <div class="sig-box">
